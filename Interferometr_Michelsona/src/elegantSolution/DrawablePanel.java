...
public class DrawablePanel extends JPanel {
	...
	public void paint(Graphics polygon) {
		...
		// Fala ze zrodla
		sD.horizontalDraw(polygon2d, new Point2D.Double(width / 16, centerY),
				new Point2D.Double(centerX, centerY), 50, 4, Color.black);

		// Fala po przejsciu przez zwierciadlo srodkowe
		sD.horizontalDraw(polygon2d, new Point2D.Double(centerX, centerY),
				new Point2D.Double(centerX + 2 * width / 5, centerY ), 25, 4, Color.black);
